          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <Pressable
                ...
                style={[styles.inputWrapper, device.isTV && focusedId === 'username' && styles.tvFocusedInput]}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <Pressable
                  ...
                  onBlur={() => setFocusedId(null)}
                  style={[styles.inputWrapper, { flex: 1 }, device.isTV && focusedId === 'password' && styles.tvFocusedInput]}>
